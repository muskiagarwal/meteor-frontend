    ...
    <section style={{ background: "#09090B", padding: "100px 28px" }}>
      <div style={{ maxWidth: 1160, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 400px", alignItems: "center", gap: 72 }}>
        ...
        <div>
          ...
          >
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "4px 12px", borderRadius: 100, background: "rgba(124,58,237,.2)", border: "1px solid rgba(124,58,237,.35)", marginBottom: 20 }}>
              <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#a78bfa" }} className="animate-pulse-dot" />
              <span style={{ fontSize: 11, fontWeight: 700, color: "#a78bfa", letterSpacing: ".06em", textTransform: "uppercase" }}>Auto-Apply</span>
            </div>
            <h2 style={{ fontFamily: "var(--font-bricolage)", fontWeight: 800, fontSize: "clamp(28px,3.5vw,44px)", letterSpacing: "-.03em", color: "#fff", margin: "0 0 18px", lineHeight: 1.1 }}>
              ...
              <span style={{ background: "linear-gradient(135deg,#a78bfa,#60a5fa)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>while you do nothing</span>
            </h2>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              {STEPS.map((s, i) => (
                ...
                >
                  <div style={{ width: 30, height: 30, borderRadius: 8, background: "linear-gradient(135deg,#7C3AED,#2563EB)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 800, color: "#fff", flexShrink: 0, marginTop: 1 }}>{s.n}</div>
                  <div>
            ...
            <motion.a
              ...
              viewport={{ once: true }}
              whileHover={{ scale: 1.03, boxShadow: "0 8px 28px rgba(124,58,237,.5)" }}
              whileTap={{ scale: 0.97 }}
              transition={{ delay: 0.5, duration: 0.4 }}
              style={{ display: "inline-flex", alignItems: "center", gap: 8, marginTop: 36, padding: "13px 26px", borderRadius: 7, background: "linear-gradient(135deg,#7C3AED,#2563EB)", color: "#fff", fontWeight: 700, fontSize: 14, textDecoration: "none", boxShadow: "0 4px 16px rgba(124,58,237,.35)" }}
            >
              Try auto-apply free
        ...
        >
          <div style={{ position: "absolute", inset: -20, background: "radial-gradient(ellipse, rgba(124,58,237,.2) 0%, transparent 70%)", filter: "blur(24px)", pointerEvents: "none" }} />
